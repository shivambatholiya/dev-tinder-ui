            ...
            <div className="flex items-center gap-4">
                {isLoggedIn ? (
                            ...
                            <div className="absolute right-0 mt-3 w-48 bg-gray-900 border border-gray-800 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
                                <ul className="py-2 text-sm text-gray-300">
                                    ...
                                    <li
                                        ...
                                        className="px-4 py-2 hover:bg-red-600/20 text-red-400 cursor-pointer"
                                    >
                                        Logout
                                    </li>
                                </ul>
                    ...
                    <>
                        ...
                        <Link
                            to="/signup"
                            className="px-5 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-sm font-semibold transition"
                        >
                            Sign Up
                        </Link>
                    </>
